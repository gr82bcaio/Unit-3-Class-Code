...
print("Your character is a " + character_class + " " + character_race +
      " with " + str(character_mana) + " mana.")
...
num_casts = int(input("How many times do you want cast the fire spell (10 mana per cast): "))
if 0 <= num_casts <= 5:
    print(f"The {character_class} {character_race} cast a fire spell {num_casts} times.")
    print("|===o"," ~~ x x x ~~   "*num_casts)
else:
